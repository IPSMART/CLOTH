                    ...
                    if (MSG >= 0) {
                        ...
                        if (MSG >= 0) {
                            ...
                            if (value1 == "true") {
                                ...
                                if ((MENU_PARA == "SBPCK" || MENU_PARA == "SB" || MENU_PARA == "SBDIR" || MENU_PARA == "SR" || MENU_PARA == "SBEXP") && retFloat($("#CONVQTYPUNIT").val()).toFixed(0) != "0") {
                                    $("#BLQNTY").focus();
                                }
                            }
...
function FillBarcodeArea(str, Table, i) {
    ...
    if (str != "") {
        ...
        if ((Table != "COPYLROW") && (MENU_PARA == "SBPCK" || MENU_PARA == "SB" || MENU_PARA == "PB" || MENU_PARA == "OP" || MENU_PARA == "OTH" || MENU_PARA == "PJRC")) {
                ...
                for (j = 0; j <= GridRowMain - 1; j++) {
                    ...
                    if (flag == true) {
                        ...
                        if (retStr($("#ITGRPCD").val()) == retStr($("#B_ITGRPCD_" + j).val()) && retStr($("#MTRLJOBCD").val()) == retStr($("#B_MTRLJOBCD_" + j).val()) &&
                            ...
                            retStr($("#BLUOMCD").val()) == retStr($("#B_BLUOMCD_" + j).val()) && retFloat($("#BLQNTY").val()) == retFloat($("#B_BLQNTY_" + j).val())
) {
            ...
            if (document.getElementById("MergeBarItem").checked == true) {
                ...
                for (j = 0; j <= GridRowMain - 1; j++) {
                    ...
                    if (flag == true) {
                     ...
                     retFloat(BLQNTY) == retFloat($("#B_BLQNTY_" + j).val()) && retStr(BLUOMCD) == retStr($("#B_BLUOMCD_" + j).val())) {
...
function CalculateBargridQnty(tableid, index) {
    ...
    if ((MENU_PARA == "SBPCK" || MENU_PARA == "SB" || MENU_PARA == "SBDIR" || MENU_PARA == "SR" || MENU_PARA == "SBEXP") && (retFloat($("#" + CUTLENGTHID).val()) == 0 || retFloat($("#" + NOSID).val()) == 0)) {
