...
function ClearAllSalePose() {
    var DefaultAction = $("#DefaultAction").val();
    if (DefaultAction == "V") return true;
    ClearAllTextBoxes("AUTONO,INCLRATEASK,MNTHCD,EMD_NO,ITCD,DOCNO,SHIPDOCNO,SHIPDOCDT,M_SLIP_NO,BLTYPE,RTDEBCD,RTDEBNM,MOBILE,ADDR,RETDEBSLCD,EFFDT,TAXGRPCD,IRNNO,NM,MOBNO,ADDR_,CITY_,INC_RATE,MergeItem,GOCD,GONM,PRCCD,REVCHRG,ROAMT,DISCONBILL,NETDUE,BLAMT,PAYAMT,OTHAMT,MEMOAMT,RETAMT,MaterialJobChk_,ALLMTRLJOBCD,M_BARCODE,STYLENO,M_BARCODE,R_BARCODE,PARTCD,R_STYLENO,FDT,TDT,R_DOCNO,BARNO,GSTNO,GSTSLNM,GSTSLADD1,GSTSLDIST,GSTSLPIN");
