    ...
    public class T_OUTRECPROCESSController : Controller
    {
        ...
        public ActionResult GetTDSDetails(string val, string TAG, string PARTY)
        {
            try
            {
                ...
                if (val == null)
                {
                    return PartialView("_Help2", masterHelp.TDSCODE_help(TAG, val, PARTY, "TDS", linktdscode));
                }
                else
                {
                    string str = masterHelp.TDSCODE_help(TAG, val, PARTY, "TDS", linktdscode);
                    return Content(str);
                }
            }
            catch (Exception Ex)
        ...
        //public ActionResult FillBarCodeData(TransactionOutRecProcess VE)
        //{
        //    try
        //    {
        ...
        //        }
        //        VE.DefaultView = true;
        //        return PartialView("_T_OUTRECPROCESS_PRODUCT", VE);
        //    }
        //    catch (Exception ex)
        //    {
        //        Cn.SaveException(ex, "");
        ...
        //    return PartialView("_T_OUTRECPROCESS_QtyRequirement", VE);
        //}
        //public ActionResult AddRow(TransactionOutRecProcess VE, int COUNT, string TAG)
        //{
        //    ImprovarDB DB = new ImprovarDB(Cn.GetConnectionString(), CommVar.CurSchema(UNQSNO));
        //    Cn.getQueryString(VE);
        ...
        public ActionResult ParkRecord(FormCollection FC, TransactionOutRecProcess stream, string menuID, string menuIndex)
        {
            try
            {
