                ...
                if (val.retStr() == "" || tbl.Rows.Count > 1)
                {
                    ...
                    for (int i = 0; i <= tbl.Rows.Count - 1; i++)
                    {
                        SB.Append("<tr><td>" + tbl.Rows[i]["docno"] + "</td><td>" + tbl.Rows[i]["docdt"].retStr().Remove(10) + " </td><td>" + tbl.Rows[i]["proguniqno"] + " </td><td>"
                            ...
                            + tbl.Rows[i]["progautoslno"] + " </td><td>" + tbl.Rows[i]["itremark"] + " </td><td>" + tbl.Rows[i]["fabitnm"] + " </td><td>" + tbl.Rows[i]["ORDDOCNO"] + " </td><td>" + tbl.Rows[i]["makestyleno"] + " </td></tr>"); 
                    }
                    var hdr = "Doc No." + Cn.GCS() + "Doc Dt." + Cn.GCS() + "Uniq. No." + Cn.GCS() + "Bar Code No" + Cn.GCS()
                        ...
                        + Cn.GCS() + "progautoslno" + Cn.GCS() + "Item Remarks" + Cn.GCS() + "Fabric Item" + Cn.GCS() + "Order No." + Cn.GCS() + "Make StyleNo.";
