    ...
    public class Rep_EWB_GenController : Controller
    {
        ...
        public ActionResult ShowList(EWayBillReport VE, FormCollection FC)
        {
            try
            {
                ...
                query += "" + fdbnm + ".m_subleg e, " + fdbnm + ".m_loca f, " + fdbnm + ".m_subleg_locoth g , " + dbnm + ".m_doctype h, " + fdbnm + ".T_TXNeinv i ";
            ...
            try
            {
                ...
                while (i < tbl.Rows.Count)
                {
                    ...
                    prejson.transMode = "1";//ah                       
                                            ...
                                            //}
                                            //prejson.invamt = (VE.Checkbox3 == true ? double.Parse(tbl.Rows[i]["blamt"].ToString()) : double.Parse((tbl.Rows[i]["blamt"].retDbl() - tbl.Rows[i]["tcsamt"].retDbl()).ToString()));
                ...
                if (Command == "UPLOAD EXCEL")
                {
                    ...
                    {//change date 11/11/2020
                        ...
                        if ((file != null) && (file.ContentLength > 0) && !string.IsNullOrEmpty(file.FileName))
                        {
                            ...
                            //using (var package = new ExcelPackage(file.InputStream))//Using EPPlus
                            //{
