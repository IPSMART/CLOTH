...
{
    public class M_BarcodePrintFormatController : Controller
    {
        ...
        // GET: M_BarcodePrintFormat
        public ActionResult M_BarcodePrintFormat(string op = "", string key = "", int Nindex = 0, string searchValue = "")
        {
            try
            {
