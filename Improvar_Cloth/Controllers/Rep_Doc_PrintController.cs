...
namespace Improvar.Controllers
{
    public class Rep_Doc_PrintController : Controller
    {
        ...
        public ActionResult Rep_IssueChallan_Print(Rep_Doc_Print VE)
        {
            ...
            IR.Columns.Add("actof", typeof(string), "");
            ...
            IR.Columns.Add("lpcs", typeof(double), "");
            IR.Columns.Add("nqnty", typeof(double), "");
            IR.Columns.Add("tlqnty", typeof(double), "");
            IR.Columns.Add("recoskip", typeof(string), "");
            IR.Columns.Add("nslno", typeof(double), "");
