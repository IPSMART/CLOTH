...
namespace Improvar.Report {
    ...
    public class SaleBillHalf : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Improvar.Report.SaleBillHalf.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSaleBillHalf : Component, ICachedReport {
        
        public CachedSaleBillHalf() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SaleBillHalf rpt = new SaleBillHalf();
            rpt.Site = this.Site;
            return rpt;
        }
