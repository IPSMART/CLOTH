...
namespace Improvar.Report {
    ...
    public class SaleBill_Job : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Improvar.Report.SaleBill_Job.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedSaleBill_Job : Component, ICachedReport {
        
        public CachedSaleBill_Job() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            SaleBill_Job rpt = new SaleBill_Job();
            rpt.Site = this.Site;
            return rpt;
        }
