...
namespace Improvar.Report {
    ...
    public class Rep_JobBill : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Improvar.Report.Rep_JobBill.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedRep_JobBill : Component, ICachedReport {
        
        public CachedRep_JobBill() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Rep_JobBill rpt = new Rep_JobBill();
            rpt.Site = this.Site;
            return rpt;
        }
