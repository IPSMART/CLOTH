    ...
    public class MasterHelp : MasterHelpFa
    {
        ...
        public string ITCD_help(string val, string ITGTYPE, string ITGRPCD = "", string FABITCD = "", string DOC_EFF_DT = "", string JOB_CD = "")
        {
            try
            {
                ...
                sql += "select a.itcd, a.itnm, a.uomcd, a.itgrpcd, b.itgrpnm,b.bargentype, b.itgrptype,a.styleno, a.PCSPERSET,nvl(a.hsncode,b.hsncode)hsncode, a.fabitcd, c.itnm fabitnm, a.styleno||' '||a.itnm itstyle ";
        ...
        public string T_TXN_BARNO_help(string barnoOrStyle, string menupara, string DOCDT, string TAXGRPCD = "", string GOCD = "", string PRCCD = "", string MTRLJOBCD = "", string ITCD = "", bool exactbarno = true, string PARTCD = "", string BARNO = "", string SKIPAUTONO = "")
        {
            ...
            if (menupara == "PB" || menupara == "OP" || menupara == "OTH")
            {
